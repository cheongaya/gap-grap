...
public class algorithm02 {
     ...
     *
     * [해결하기]
     * 1. 수가 정렬된 상태이므로 중간의 값을 하나 선택한다
     * 2. 찾으려는 값이 그보다 크면 범위를 오른쪽으로 그보다 작으면 범위를 왼쪽으로 좁힐 수 있다.
     * 3. 한번 비교할 때마다 1/2씩 범위가 좁혀진다
     *
     */

    public static void main(String[] args) {

        int[] numbers = {12, 25, 31, 48, 54, 66, 70, 83, 95, 108}; // 수가 정렬된 상태
